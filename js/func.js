"use strict";
var showOnScreen = document.getElementById('display');
showOnScreen.style.display = "block";
var showOnScreen2 = document.getElementById('display2');
